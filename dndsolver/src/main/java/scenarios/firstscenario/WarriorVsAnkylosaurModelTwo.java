...
public class WarriorVsAnkylosaurModelTwo {
	/*
	 * Ce scénario représente un combat entre un guerrier (niveau 10) et un
	 * ennemi (ankylosaure) tiré du bestiaire du jeu de rôle pathfinder (un
	 * version de donjons et dragons)
	 * 
	 * Le guerrier à 89 points de vie et fait 46 dmg par attaque
	 * 
	 * L'ankylosaure à 75 points de vie et fait 25 dmg par attaque
	 * 
	 * Dans le cadre de ce scénario, c'est le guerrier qui agira en premier
	 * 
	 * Pour garder ce scénario très simple, il n'y aura pas de mouvement de la
	 * part du guerrier ni de l'ankylosaure.
	 */
	...
	public WarriorVsAnkylosaurModelTwo() {
		...
		finalPartyHp = makeIntVar("final party hp", 0, WARRIOR_MAX_HP,
				Options.V_OBJECTIVE);
	...
	private void prepareRound1Constraints() {
		...
		model.addConstraint(ifThenElse(ankylosaurDead,
				eq(ankylosaurTarget1, 0), neq(ankylosaurTarget1, 0)));

		model.addConstraint(neq(warriorTarget1, 0));

		// Résultat des attaques du guerrier
		...
		model.addConstraint(implies(ankylosaurNotAttacked,
				eq(ankylosaurHp1, ANKYLOSAUR_MAX_HP)));
		...
		model.addConstraint(implies(warriorNotAttacked,
				eq(warriorTarget1, WARRIOR_MAX_HP)));
	...
	private void prepareRound2Constraints() {
		...
		model.addConstraint(ifThenElse(ankylosaurDead,
				eq(ankylosaurTarget2, 0), neq(ankylosaurTarget2, 0)));

		model.addConstraint(ifThenElse(warriorDead, eq(warriorTarget2, 0),
				neq(warriorTarget2, 0)));
		...
		model.addConstraint(implies(ankylosaurNotAttacked,
				eq(ankylosaurHp2, ankylosaurHp1)));
	...
	private void prepareRound3Constraints() {
		...
		model.addConstraint(ifThenElse(ankylosaurDead,
				eq(ankylosaurTarget3, 0), neq(ankylosaurTarget3, 0)));

		model.addConstraint(ifThenElse(warriorDead, eq(warriorTarget3, 0),
				neq(warriorTarget3, 0)));
		...
		model.addConstraint(implies(ankylosaurNotAttacked,
				eq(ankylosaurHp3, ankylosaurHp2)));
	...
	public void solveScenario() {
		...
		if (solveur.maximize(false)) {
			System.out.println("Warrior final hp = "
					+ solveur.getVar(warriorHp3).getVal());
			System.out.println("----------------------------");
			System.out.println("ankylosaur final hp = "
					+ solveur.getVar(ankylosaurHp3).getVal());
			System.out.println("----------------------------");
			System.out.println("ROUND 1");
			System.out.println("Warrior target = "
					+ solveur.getVar(warriorTarget1).getVal());
			System.out.println("ankylosaur target = "
					+ solveur.getVar(ankylosaurTarget1).getVal());
			System.out.println("----------------------------");
			System.out.println("Warrior hp after round 1 = "
					+ solveur.getVar(warriorHp1).getVal());
			System.out.println("ankylosaur hp after round 1 = "
					+ solveur.getVar(ankylosaurHp1).getVal());
			System.out.println("----------------------------");
			System.out.println("ROUND 2");
			System.out.println("Warrior target = "
					+ solveur.getVar(warriorTarget2).getVal());
			System.out.println("ankylosaur target = "
					+ solveur.getVar(ankylosaurTarget2).getVal());
			System.out.println("----------------------------");
			System.out.println("Warrior hp after round 2 = "
					+ solveur.getVar(warriorHp2).getVal());
			System.out.println("ankylosaur hp after round 2 = "
					+ solveur.getVar(ankylosaurHp2).getVal());
			System.out.println("----------------------------");
			System.out.println("ROUND 3");
			System.out.println("Warrior target = "
					+ solveur.getVar(warriorTarget3).getVal());
			System.out.println("ankylosaur target = "
					+ solveur.getVar(ankylosaurTarget3).getVal());
			System.out.println("----------------------------");
			System.out.println("Warrior hp after round 3 = "
					+ solveur.getVar(warriorHp3).getVal());
			System.out.println("ankylosaur hp after round 3 = "
					+ solveur.getVar(ankylosaurHp3).getVal());
			System.out.println("----------------------------");
			System.out.println("Total party life = "
					+ solveur.getVar(finalPartyHp).getVal());
		} else {
